...
A collection of Python scripts utilizing AWS Bedrock Claude Sonnet 5 model, providing various text processing capabilities including translation, summarization, and text formalization.
...
**Default Model**: The scripts use `global.anthropic.claude-sonnet-5` (Claude Sonnet 5) by default in the `ap-northeast-1` region.
